...
if "gcc" in script_name:
    ...
    mods["compilers"] = CommentedMap({  "c"         : f"{comp_root}/compiler/latest/bin/icx",
                                        "cxx"       : f"{comp_root}/compiler/latest/bin/icpx",
                                        "fortran"   : f"{comp_root}/compiler/latest/bin/ifx" })
